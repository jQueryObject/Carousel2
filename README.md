...
<div id="wrapper"><!-- 最外层部分 -->
  <div id="banner"><!-- 轮播部分 -->
    <ul class="imgList"><!-- 图片部分 -->
      <li><a href="#"><img src="images/header1.jpg" width="400px" height="200px" alt="puss in boots1"></a></li>
      <li><a href="#"><img src="images/header2.jpg" width="400px" height="200px" alt="puss in boots2"></a></li>
      <li><a href="#"><img src="images/header3.jpg" width="400px" height="200px" alt="puss in boots3"></a></li>
      <li><a href="#"><img src="images/header4.jpg" width="400px" height="200px" alt="puss in boots4"></a></li>
      <li><a href="#"><img src="images/header5.jpg" width="400px" height="200px" alt="puss in boots5"></a></li>
    </ul>
    ...
    <ul class="indexList"><!-- 图片右下角序号部分 -->
      <li class="indexOn"><img src="images/header1.jpg" width="40px" height="20px"></li>
      <li><img src="images/header2.jpg" width="40px" height="20px"></li>
      <li><img src="images/header3.jpg" width="40px" height="20px"></li>
      <li><img src="images/header4.jpg" width="40px" height="20px"></li>
      <li><img src="images/header5.jpg" width="40px" height="20px"></li>
    </ul>
  </div>
</div>
</body>
